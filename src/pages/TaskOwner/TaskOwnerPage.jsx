        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="flex-1 p-6 overflow-y-auto">
                    {/* Greeting Section */}
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Good Morning, Marcus! 👋</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-white rounded-xl p-6 border border-gray-200 relative overflow-hidden">
                            <div className="relative z-10">
                                ...
                                <p className="text-xs text-green-600 font-semibold">+1 this week</p>
                            </div>
                        ...
                        <div className="bg-white rounded-xl p-6 border border-gray-200 relative overflow-hidden">
                            <div className="relative z-10">
                                <p className="text-sm text-gray-600 mb-1">Total Spent in Escrow</p>
                                <p className="text-3xl font-bold text-gray-900 mb-1">$12,450</p>
                                <p className="text-xs text-gray-600">Across 3 active contracts</p>
                            </div>
                            <div className="absolute top-4 right-4 opacity-10">
                                <svg className="w-16 h-16 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="bg-white rounded-xl p-6 border border-gray-200 relative overflow-hidden">
                            <div className="relative z-10">
                                ...
                                <a href="#" className="text-xs text-blue-600 font-semibold hover:underline">Go to inbox →</a>
                            </div>
                            <div className="absolute top-4 right-4 opacity-10">
                                <svg className="w-16 h-16 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">Posted 2 days ago • 12 Proposals</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2">
                                            <h3 className="font-semibold text-gray-900">Product Designer (UX/UI)</h3>
                                            <span className="bg-red-100 text-red-600 text-xs font-bold px-2 py-0.5 rounded">Urgent</span>
                                        </div>
                                        <p className="text-sm text-gray-600">Posted 5 days ago • 28 Proposals</p>
                                    </div>
                                </div>
                                <button className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg transition-colors">
                                    Manage
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200 mb-6">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-bold text-gray-900">Contracts in Escrow</h2>
                            <a href="#" className="text-sm text-blue-600 font-semibold hover:underline">View Contracts</a>
                        </div>
                        <div className="space-y-4">
                            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-600">Contract with David K.</p>
                                    </div>
                                </div>
                                <div className="space-y-2 mb-4">
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="text-gray-600">Funded: <span className="font-semibold text-gray-900">$5,000</span></span>
                                        <span className="text-gray-600">Released: <span className="font-semibold text-gray-900">$2,500</span></span>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="bg-orange-100 text-orange-600 text-xs font-semibold px-3 py-1 rounded-full">Pending</span>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-600">Contract with Sarah J.</p>
                                    </div>
                                </div>
                                <div className="space-y-2 mb-4">
                                    <div className="flex items-center justify-between text-sm">
                                        <span className="text-gray-600">Funded: <span className="font-semibold text-gray-900">$3,200</span></span>
                                        <span className="text-gray-600">Released: <span className="font-semibold text-gray-900">$800</span></span>
                                    </div>
                                    <div className="w-full bg-gray-200 rounded-full h-2">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-xs text-gray-500 mb-1">Next Milestone</p>
                                        <p className="text-sm font-semibold text-gray-900">Wireframes</p>
                                    </div>
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200">
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-xl font-bold text-gray-900">Recommended Talent</h2>
                            <div className="flex items-center gap-2">
                                ...
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            <span className="bg-blue-100 text-blue-600 text-xs font-semibold px-2 py-0.5 rounded">Verified</span>
                                        </div>
                                        <p className="text-sm text-gray-600 mb-2">Senior DevOps Engineer</p>
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-3">
                                            <span className="text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded">AWS</span>
                                            <span className="text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded">Kubernetes</span>
                                            <span className="text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded">CI/CD</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm font-semibold text-gray-900">$85/hr</span>
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gray-600 mb-2">Illustrator & Graphic Artist</p>
                                        <div className="flex items-center gap-1 mb-2">
                                            <span className="text-yellow-500">★</span>
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-3">
                                            <span className="text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded">Adobe AI</span>
                                            <span className="text-xs bg-gray-200 text-gray-700 px-2 py-1 rounded">Branding</span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm font-semibold text-gray-900">$55/hr</span>
                                            <span className="text-xs text-gray-600">100% Success</span>
                                        </div>
                                        <div className="w-full bg-gray-200 rounded-full h-1.5 mt-2">
