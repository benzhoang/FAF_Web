        ...
        <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
                ...
                <p className="text-sm text-gray-600 max-w-xl mx-auto">
                    Please review your job details before posting. You can edit any section if needed.
                </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm mb-6">
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-sm font-semibold text-gray-900">Budget & Milestones</h2>
                    </div>
                    <button
                        type="button"
                        onClick={onEditStep3}
                ...
                <div className="px-6 py-5 grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
                    <div>
                        ...
                        <div className="text-xl font-bold text-gray-900">
                            ...
                            <span className="ml-1 text-xs font-normal text-gray-500">Fixed Price</span>
                        </div>
                    </div>
                    <div>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl px-6 py-4 mb-8 flex gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-blue-900">
                        Because you chose <span className="font-semibold">Short-term Protected</span>, payment will be held securely in escrow.
                        Funds are only released to the worker after you review and approve each milestone submission.
                    </p>
                </div>
            </div>
