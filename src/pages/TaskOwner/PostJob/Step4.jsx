...
const Step4Contract = ({
    ...
    useEffect(() => {
        if (!isDraftDirty) setContractHtml(defaultContractHtml);
    }, [defaultContractHtml, isDraftDirty]);
    ...
    const editor = useEditor({
        ...
        content: contractHtml || defaultContractHtml,
        editable: isEditing,
        editorProps: {
            attributes: {
                class:
    ...
    useEffect(() => {
        if (!editor) return;
        // Khi thay đổi template (jobTitle/selectedType/inputs) và draft chưa bị chỉnh tay
        if (!isDraftDirty) editor.commands.setContent(defaultContractHtml, false);
        ...
        <div className="max-w-5xl mx-auto">
            <div className="mb-6">
                ...
                <p className="text-sm text-gray-600">
                    Please read the contract below carefully and confirm your agreement to continue.                </p>
            </div>
                        ...
                        <div className="max-h-[70vh] overflow-auto p-8">
                            ...
                            {!isEditing ? (
                                <div
                                    ...
                                    dangerouslySetInnerHTML={{ __html: contractHtml || defaultContractHtml }}
                                />
                            ) : (
